 ...
 */
 ...
 public class PokemonPesquisa {
     ...
     public PokemonPesquisa(int id, int generation, String name, String description, ArrayList<String>  types, ArrayList<String>  abilities, double weight, double height, int captureRate, boolean isLegendary, Date captureDate) {
         this.id = id;
     ...
     public PokemonPesquisa Clone() { return new PokemonPesquisa( this.id, this.generation, this.name, this.description, this.types, this.abilities, this.weight, this.height, this.captureRate, this.isLegendary, this.captureDate); }
     ...
     public static boolean isFim(String entrada){
         ...
         public static PokemonPesquisa criarPokemon(String linha) {
             PokemonPesquisa pokemon = new PokemonPesquisa();
     ...
     public static PokemonPesquisa[] lerPokemon(PokemonPesquisa pokemon[]) {
     ...
     public static PokemonPesquisa ProcuraPokemon(PokemonPesquisa pokemon[], int id) {
    ...
    public static PokemonPesquisa ProcuraPokemon(PokemonPesquisa pokemon[], String name) {
    ...
    public static void GravarArquivoDeExecucao(String filename,long FimTime, int Comparacoes ){
     ...
     public static void main(String[] args) {
        ...
        int Comparacoes = 0;
         ...
         PokemonPesquisa pokemon[] = new PokemonPesquisa[801];
         pokemon = lerPokemon(pokemon);
         
         PokemonPesquisa pokemonsBuscados[] = new PokemonPesquisa[200];
         ...
         // Ler até encontrar "FIM"
          while (parar) {
              ...
              if (isFim(entrada)) {
                ...
                ids[i++] = Integer.parseInt(entrada);
              }
          }
        ...
        parar = true; //Reiniciar variáveis de controle
         ...
         while (parar) {
            ...
            if (isFim(entrada)) {
               ...
               pokemonsBuscados[p++] = ProcuraPokemon(pokemon, entrada) ;
         ...
         for(int j = 0; j < p; j++){
            ...
            for(int k = 0; k < i; k++){
                Comparacoes ++;
                if(pokemonsBuscados[j] != null && pokemonsBuscados[j].getId() == ids[k]){
                    encontrado = true;
                }
            }
