 ...
 */
 ...
 public class PokemonSelecao {
    ...
    public static int[] ordenacaoSelecao(Pokemon pokemon[], int n){
     ...
     public static void main(String[] args) {
        ...
        int dados[] = ordenacaoSelecao(pokemonsBuscados, i);
        ...
        for(int j = 0; j < i; j++){
         ...
         GravarArquivoDeExecucao("857859_selecao.txt", dados[0], dados[1], FimTime); //Arquivo de analise de Execução
