 ...
 */
 ...
 public class Pokemon{
    ...
    public static void OrdenarPokemons_PorName(Pokemon pokemon[], int esq, int dir) {
        int i = esq, j = dir;
        ...
        if (esq < j)
            OrdenarPokemons_PorName(pokemon, esq, j);
        if (i < dir)
            OrdenarPokemons_PorName(pokemon, i, dir);
    }
     ...
     public static void main(String[] args) {
        ...
        //--------------------Metodos de ordenação por countingsort------------------------------//
            ...
            OrdenarPokemons_PorName(pokemonsBuscados, 0, n-1);
        ...
        for(int j = 0; j < n; j++){
         ...
         GravarArquivoDeExecucao("857859_coutingsort.txt", comparacoes, movimentacoes, FimTime); //Arquivo de analise de Execução
