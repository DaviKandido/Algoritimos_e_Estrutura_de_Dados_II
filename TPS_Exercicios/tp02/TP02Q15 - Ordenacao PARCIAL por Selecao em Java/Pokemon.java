 ...
 */
 ...
 public class Pokemon {
    ...
    public static int[] ordenacaoSelecaoParcial(Pokemon pokemon[], int n, int k){
     ...
     public static void main(String[] args) {
        ...
        int dados[] = ordenacaoSelecaoParcial(pokemonsBuscados, i, 10);
        ...
        for(int j = 0; j < 10; j++){
         ...
         GravarArquivoDeExecucao("857859_selecaoParcial.txt", dados[0], dados[1], FimTime); //Arquivo de analise de Execução
