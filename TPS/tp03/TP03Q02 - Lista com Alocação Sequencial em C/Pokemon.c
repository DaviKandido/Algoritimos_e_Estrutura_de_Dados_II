...
int main(void) {
    ...
    while (scanf("%s", entrada) && !isFim(entrada)) {
        ...
        inserirFim( procurar(pokemons, id));
    }
    ...
    scanf("%d", &numOp);
        ...
        for(int j = 0; j < numOp; j++){
            ...
            if(strcmp(op, "II") == 0){
                ...
                scanf("%d", &num);
                Movimentacoes++;
                inserirInicio(procurar(pokemons, num));
                ...
                scanf("%d", &num);
                Movimentacoes++;
                inserirFim(procurar(pokemons, num));

            }else  Comparacoes++; if(strcmp(op, "RI") == 0){

                Movimentacoes++;
                pokesExcluidos[k++] = removerInicio();

            }else  Comparacoes++; if(strcmp(op, "RF") == 0){

                Movimentacoes++;
                pokesExcluidos[k++] = removerFim();
                ...
                scanf("%d", &num);
                Movimentacoes++;
                inserir(procurar(pokemons, num), pos);
    ...
    GravarArquivoDeExecucao("857859_AlocacaoSequencial.txt", timeTotal);
